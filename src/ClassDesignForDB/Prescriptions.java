...
public class Prescriptions {
	...
	public Prescriptions(String id,String phonefk,String firstp,String secondp,String third,String fourth,
	...
	public void setFirstp(String string) {
		this.firstp = new SimpleStringProperty(string);
	}
